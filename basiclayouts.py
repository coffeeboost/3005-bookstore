...
class Dialog(QDialog):
    ...
    def __init__(self):
        ...
        widget2.setHorizontalHeaderLabels(["pub_name", "address", "email", "account_num", "phone_num"])
        query = QSqlQuery("SELECT pub_name, address, email, account_num, phone_num FROM publishers")
        # rows = 1
        while query.next():
            ...
            # widget2.setItem(rows, 1, QTableWidgetItem(str(query.value(1))))
            # widget2.setItem(rows, 2, QTableWidgetItem(str(query.value(2))))
